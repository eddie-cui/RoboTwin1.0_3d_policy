...
sys.path.append('3D-Diffusion-Policy/diffusion_policy_3d')
...
class TrainDP3Workspace:
    ...
    def get_policy_and_runner(self, cfg, checkpoint_num=3000):
        ...
        if not cfg.policy.use_pc_color:
            ckpt_file = pathlib.Path(f'/data/sea_disk0/cuihz/code/RoboTwin/checkpoints/{cfg.task.name}_{cfg.head_camera_type}_{cfg.expert_data_num}_{cfg.training.seed}/{checkpoint_num}.ckpt')
        else:
            ckpt_file = pathlib.Path(f'/data/sea_disk0/cuihz/code/RoboTwin/checkpoints/{cfg.task.name}_{cfg.head_camera_type}_{cfg.expert_data_num}_w_rgb_{cfg.training.seed}/{checkpoint_num}.ckpt')
...
def main(cfg):
    cfg.task.name = str(cfg.task.name) + '_' + str(cfg.head_camera_type) + '_' + str(cfg.expert_data_num)
